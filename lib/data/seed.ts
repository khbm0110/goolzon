...
export const CLUB_DATABASE: Record<string, ClubProfile> = {
  'nassr': {
    ...
    squad: [
      { id: 'cr7', name: 'كريستيانو رونالدو', englishName: 'Cristiano Ronaldo', age: 40, birthDate: '1985-02-05', birthPlace: 'فونشال، البرتغال', heightCm: 187, weightKg: 85, preferredFoot: 'RIGHT', number: 7, position: 'ST', rating: 86, nationality: 'https://flagcdn.com/w40/pt.png', stats: { pac: 77, sho: 88, pas: 75, dri: 80, def: 34, phy: 74 }, image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=cr7', marketValue: 15000000, seasonStats: { matches: 24, goals: 26, assists: 7, rating: 8.1, minutes: 2088, yellowCards: 3, redCards: 0, shots: 98, shotsOnTarget: 52, passAccuracy: 81 } },
  ...
  'hilal': {
    ...
    squad: [
      { id: 'ney', name: 'نيمار جونيور', englishName: 'Neymar Jr.', age: 33, birthDate: '1992-02-05', birthPlace: 'موجي داس كروزيس، البرازيل', heightCm: 175, weightKg: 68, preferredFoot: 'RIGHT', number: 10, position: 'LW', rating: 89, nationality: 'https://flagcdn.com/w40/br.png', stats: { pac: 86, sho: 83, pas: 85, dri: 93, def: 37, phy: 61 }, image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ney', marketValue: 30000000, seasonStats: { matches: 15, goals: 9, assists: 12, rating: 8.4, minutes: 1260, yellowCards: 2, redCards: 0, shots: 44, shotsOnTarget: 21, passAccuracy: 87 } },
      ...
      { id: 'bon', name: 'ياسين بونو', englishName: 'Yassine Bounou', age: 34, birthDate: '1991-04-05', birthPlace: 'مونتريال، كندا', heightCm: 192, weightKg: 84, preferredFoot: 'RIGHT', number: 37, position: 'GK', rating: 85, nationality: 'https://flagcdn.com/w40/ma.png', stats: { pac: 84, sho: 82, pas: 76, dri: 86, def: 45, phy: 80 }, image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=bono', marketValue: 15000000, seasonStats: { matches: 24, goals: 0, assists: 0, rating: 7.7, minutes: 2160, yellowCards: 1, redCards: 0, cleanSheets: 11, saves: 68 } },
    ]
  },
  'generic': {
    id: 'generic',
